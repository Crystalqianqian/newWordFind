 ...
 * 当词库为空的时候,将文本切分为单字
 */
public class Job_SplitWord_Third {
	private static final String JOB_NAME = "Job_SplitWord_Third";
...
//			fs.delete(output_tmp, true);
			...
			job.setJarByClass(Job_SplitWord_Third.class);
			job.addCacheFile(new URI(resultPath));
			
			job.setMapperClass(Map_SplitWord_Third.class);
			job.setReducerClass(Reduce_SplitWord_Third.class);
